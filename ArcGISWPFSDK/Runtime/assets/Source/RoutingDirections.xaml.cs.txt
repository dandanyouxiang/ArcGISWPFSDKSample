    ...
    public partial class RoutingDirections : UserControl
    {
        ...
        private void routeTask_SolveCompleted(object sender, RouteEventArgs e)
        {
            ...
            foreach (Graphic graphic in _directionsFeatureSet.Features)
            {
                ...
                TextBlock textBlock = new TextBlock() { Text = text.ToString(), Tag = graphic, Margin = new Thickness(4), Cursor = Cursors.Hand , Foreground= new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Black) };
